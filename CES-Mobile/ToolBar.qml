...
ToolBar {
    ...
    states: [
        State {
            name: "normal"
            PropertyChanges { target: toolButtonFirst; iconName: "bars"; action: Settings.events.openDrawer }
        },
        State {
            name: "goback"
    ...
    property bool hasMenuList: window.currentPage && "toolBarMenuList" in window.currentPage && window.currentPage.toolBarMenuList.length > 0

    // this property can be used by some page to change the color of the ToolBar
    property string toolBarColor: Settings.theme.colorPrimary
    ...
    property color defaultTextColor: Settings.theme.colorAccent
    ...
    RowLayout {
        ...
        ToolBarButton {
            ...
            onClicked: if (action === Settings.events.cancel) toolBar.state = "normal"
        ...
        Item {
            ...
            Text {
                ...
                font { weight: Font.DemiBold; pointSize: Settings.fontSize.large }
            }
        }
        ...
        ToolBarButton {
            ...
            Menu {
                ...
                x: parent ? (parent.width - width) : 0; y: parent ? parent.height : 0
