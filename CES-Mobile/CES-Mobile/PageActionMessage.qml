...
Item {
    ...
    width: parent.width * 0.50; height: parent.width > parent.height ? parent.width * 0.30 : parent.height * 0.30
    ...
    Column {
        ...
        Rectangle {
            ...
            Icon {
                id: awesomeIcon
                size: 35; color: primaryText.color; name: "warning"
